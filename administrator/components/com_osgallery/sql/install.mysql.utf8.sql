...
CREATE TABLE IF NOT EXISTS #__os_gallery_categories (
  `id` int(11) unsigned NOT NULL auto_increment,
  `fk_gal_id` int(11) DEFAULT NULL COMMENT 'The gallery id from table __os_gallery',
...
CREATE TABLE IF NOT EXISTS #__os_gallery_connect (
  `id` int(11) unsigned NOT NULL auto_increment,
  `fk_cat_id` int(11) NOT NULL DEFAULT '0' COMMENT 'The id from table __os_gallery_categories',
  `fk_gal_img_id` int(11) DEFAULT NULL COMMENT 'The img id from table __os_gallery_img',
  PRIMARY KEY (`id`),
  FOREIGN KEY (`fk_cat_id`) REFERENCES #__os_gallery_categories(`cat_id`),
